...
contract SimpleStorage//contract is a keyword in solidity and tells the compiler that the next section of the code will define the contract 
{
    ...
    uint favnum=123;
    int fanum; //here fanum gets initialised to zero
    ...
    //function store(int _fanum) public//here we created a function called store , int_fanum is the variable that gets passed into this fn, public means the fn is public
     // {favnum= _fanum;
...
//import keyword is used to load a contract into another.
//ex: import"./SimpleStorage.sol";
